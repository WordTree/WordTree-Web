...
declare const _Cascader: SFCWithInstall<import("vue").DefineComponent<{
    ...
    input: import("vue").Ref<({
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "placeholder" | "type" | "size" | "disabled" | "modelValue" | "label" | "form" | "resize" | "autosize" | "autocomplete" | "readonly" | "clearable" | "showPassword" | "showWordLimit" | "suffixIcon" | "prefixIcon" | "tabindex" | "validateEvent" | "inputStyle">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
